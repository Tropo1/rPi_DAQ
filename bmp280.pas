...
procedure BMP280_startDevice(var BMPDevice:PI2CDevice;var mode:Byte);
...
procedure BMP280_read_register2(BMPDevice:Pointer;RegAdress:PBMP280_RegByte;BMPRecData:PBMP280_ReceiveBytes;n_Bytes:LongWord);
...
begin
  ...
  BMP280_read_register2(BMPDevice,BMPReg,BMPRecData,24);
  ...
  BMP_MEAS_TIME:=((1.25+2.3*1)+(0.575+2.3*1))/1000;
...
begin
  ...
  BMP280_read_register2(BMPDevice,BMPReg,BMPRecData,6);
...
begin
  ...
  //BMP280_read_register2(BMPDevice,BMPReg,BMPRecData,2);
